<template>
  <div>
        ...
        <table class="table table-hover mb-0 align-middle">
          ...
          <tbody>
            <tr v-for="(producto, index) in productos" :key="producto.id">
              ...
              <td>
                <img
                  :src="producto.image || 'https://via.placeholder.com/60'"
                  :alt="producto.name"
        ...
        <div class="d-flex gap-2 justify-content-end">
          ...
          <button class="btn btn-primary" @click="guardarProducto" :disabled="guardando">
            ...
            <span v-else
              ...
              >{{ modoEditar ? "Guardar cambios" : "Crear servicio" }}</span
            >
          </button>
        </div>
      </div>
    ...
    <div v-if="mostrarDetalle" class="modal-overlay" @click.self="mostrarDetalle = false">
      <div class="modal-box card shadow-lg p-4">
        <h5 class="fw-bold text-primary mb-3">
          <i class="bi bi-eye me-2"></i>Detalle del Servicio
        </h5>
        <img
          :src="productoDetalle.image || 'https://via.placeholder.com/480x200'"
        ...
        <p class="fw-bold text-success fs-5">
          {{
            Number(productoDetalle.price).toLocaleString("es-CO", {
              style: "currency",
              currency: "COP",
            })
          }}
